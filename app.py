...
model = load_model('/Users/diksha/Downloads/lstm_model_new.h5')
...
st.markdown(
    ...
    <style>
         .stApp {
        background-color: #e5f2e4; /* Light background */
      
    }
    header[data-testid="stHeader"] {
        background-color: #e5f2e4; /* Light green background */
    }
        [data-testid="stSidebar"] {
            background-color: #cde6ca; /* Light Green */
        }
        div[data-baseweb="select"] > div:focus-within {
            border-color: #cde6ca !important;
            box-shadow: 0 0 0 1px #cde6ca !important;
        }
...
st.markdown("<h1 style='text-align: center; color: green;'>Whatsapp Chat Sentiment Analyzer</h1>",
            unsafe_allow_html=True)
# File upload button
